...
#### Gene-Specific Dimensionless Rate Multipliers (New - Simple Defaults)
$$r_{u,i} \sim \text{LogNormal}(0.0, 0.5^2)$$
$$r_{s,i} \sim \text{LogNormal}(0.0, 0.5^2)$$
*Note: Conservative defaults for new simplified parameters*
...
- **New parameters only**: Only $r_{u,i}$ and $r_{s,i}$ require new default values

### Likelihood Specification

#### Dimensionally Consistent Poisson Rates
$$u_{rate,ij} = \lambda_j \times U_{0i} \times r_{u,i}$$
$$s_{rate,ij} = \lambda_j \times U_{0i} \times r_{s,i}$$
...
- $r_{u,i}, r_{s,i}$: Simplified rate multipliers replacing dynamics solutions
