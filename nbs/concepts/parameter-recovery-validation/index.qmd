...
### Poisson likelihood-only model

This model implements a baseline model that attempts to directly fit Poisson distributions to the genewise marginals across all cells.
