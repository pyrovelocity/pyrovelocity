"""
Parameter metadata for piecewise activation components.

This module provides parameter metadata definitions for the piecewise activation model components,
